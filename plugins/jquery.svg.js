...
$.extend(SVGManager.prototype, {
	...
	/** Name of the data property for instance settings.js. */
	...
	_afterLoad: function(container, svg, settings) {
		...
		try {
			...
			if (settings.settings) { // Additional settings.js
...
$.extend(SVGWrapper.prototype, {
	...
	/** Configure a SVG node.
		...
		@param settings {object} Additional settings.js for the root.
	...
	/** Change the attributes for a SVG node.
		...
		@param settings {object} The new settings.js.
		@return {SVGWrapper} This wrapper. */
	...
	/** Add a title.
		...
		@param [settings] {object} Additional settings.js for this node.
	...
	/** Add a gradient node.
		...
		@param settings {object} The settings.js for this node.
	...
	/** Create a SVG node with the given settings.js.
		@private
	...
	/** Load an external SVG document.
		...
		@param settings {boolean|function|object} Either <code>addTo</code> below or <code>onLoad</code> below or
				additional settings.js for the load with attributes below:
...
$.extend(SVGText.prototype, {
	...
	/** Add a separate text span that has its own settings.js.
		@param value {string} The actual text.
		@param settings {object} The settings.js for this text.
		@return {SVGText} This text object. */
...
/** Attach the SVG functionality to a jQuery selection.
	...
	@param [options] {object} The new settings.js to use for these SVG instances.
